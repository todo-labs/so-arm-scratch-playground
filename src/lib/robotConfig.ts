...
export const robotConfigMap: { [key: string]: RobotConfig } = {
  "so-arm101": {
    ...
    defaultJointDetails: [
      { name: "Rotation", servoId: 1, jointType: "revolute", limit: { lower: 70, upper: 290 } },
      { name: "Pitch", servoId: 2, jointType: "revolute", limit: { lower: 80, upper: 280 } },
      { name: "Elbow", servoId: 3, jointType: "revolute", limit: { lower: 80, upper: 270 } },
      { name: "Wrist_Pitch", servoId: 4, jointType: "revolute", limit: { lower: 85, upper: 275 } },
      { name: "Wrist_Roll", servoId: 5, jointType: "revolute", limit: { lower: 23, upper: 343 } },
      { name: "Jaw", servoId: 6, jointType: "revolute", limit: { lower: 170, upper: 280 } },
    ],
    orbitTarget: [1, 2, 0],
